...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $gg = "UPDATE `final_reg` SET `password1`='$password1',`password2`='$password2' WHERE `username` = '$username'";

    if ($conn->query($gg) === TRUE) {
        echo "<script>window.location.href='../user/user_login.php';</script>";
    } else {
        echo "Error: " . $gg . "<br>" . $conn->error;
    }
}
            ...
            <div class="card-body p-0">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-lg-7">
                        ...
                        <input type="submit" class="btn btn-primary btn-user btn-block" value="Save Changed Password"><br>
                        </form>
                    </div>
                </div>
            </div>
